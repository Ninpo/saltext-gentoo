...
addtl_paths = (
    os.path.join(os.pardir, "src"),  # saltext.gentoo itself (for autodoc)
...
dist = distribution("saltext.gentoo")
...
linkcheck_ignore = [r"http://localhost:\d+", r"https://www\.freedesktop\.org/.*"]
