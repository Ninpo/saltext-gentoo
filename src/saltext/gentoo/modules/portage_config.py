...
def get_installed_use(cp, use="USE"):
    ...
    .. code-block:: bash
        ...
        salt '*' portage_config.get_installed_use
    """
...
def filter_flags(use, use_expand_hidden, usemasked, useforced):
    ...
    .. code-block:: bash
        ...
        salt '*' portage_config.filter_flags use='["useflag1", "useflag2"]'
    """
    portage = _get_portage()
...
def get_all_cpv_use(cp):
    ...
    .. code-block:: bash
        ...
        salt '*' portage_config.get_all_cpv_use app-editors/vim
    """
    cpv = _get_cpv(cp)
    portage = _get_portage()
    use = None
...
def get_cleared_flags(cp):
    ...
    and use flags which now exist in /etc/portage/package.use/
    ...
    .. code-block:: bash
        ...
        salt '*' portage_config.get_cleared_flags app-editors/vim
    """
    cpv = _get_cpv(cp)
...
def is_changed_uses(cp):
    ...
    .. code-block:: bash
        ...
        salt '*' portage_config.is_changed_uses app-editors/vim
    """
    cpv = _get_cpv(cp)
